class TurkeyAddressData {
  static const Map<String, List<String>> citiesAndDistricts = {
    ...
    'AYDIN': ['BOZDOĞAN', 'BUHARKENT', 'ÇİNE', 'DİDİM', 'EFELER', 'GERMENCİK', 'İNCİRLİOVA', 'KARACASU', 'KARARPÜZLU', 'KOÇARLI', 'KÖŞK', 'KUŞADASI', 'KUYUCAK', 'NAZİLLİ', 'SÖKE', 'SULTANHİSAR', 'YENİPAZAR'],
    'BALIKESİR': ['ALTIEYLÜL', 'AYVALIK', 'BALYA', 'BANDIRMA', 'BİGADİÇ', 'BURHANİYE', 'DURSUNBEY', 'EDREMİT', 'ERDEK', 'GÖMEÇ', 'GÖNEN', 'HAVRAN', 'İVRİNDİ', 'KARESİ', 'KEPSUT', 'MANYAS', 'MARMARA', 'SAVAŞTEPE', 'SINIRGI', 'SUSURLUK'],
    ...
    'ESKİŞEHİR': ['ALPU', 'BEYLİKOVA', 'ÇİFTELER', 'GÜNYÜZÜ', 'HAN', 'İNÖNÜ', 'MAHMUDİYE', 'MİHALG GAZİ', 'MİHALIÇÇIK', 'ODUNPAZARI', 'SARICAKAYA', 'SEYİTGAZİ', 'SİVRİHİSAR', 'TEPEBAŞI'],
    ...
    'KONYA': ['AHIRLI', 'AKÖREN', 'AKŞEHİR', 'ALTINEKİNE', 'BEYŞEHİR', 'BOZKIR', 'CİHANBEYLİ', 'ÇELTİK', 'ÇUMRA', 'DERBENT', 'DEREBUCAK', 'DOĞANHİSAR', 'EMİRGAZİ', 'EREĞLİ', 'GÜNEYSINIR', 'HADİM', 'HALKAPINAR', 'HÜYÜK', 'ILGIN', 'KADINHANI', 'KARAPINAR', 'KARATAY', 'KULU', 'MERAM', 'SARAYÖNÜ', 'SELÇUKLU', 'SEYDİŞEHİR', 'TAŞKENT', 'TUZLUKÇU', 'YALIHÜYÜK', 'YUNAK'],
    ...
    'NEVŞEHİR': ['ACIGÖL', 'AVANOS', 'DERİNKUYU', 'GÜLŞEHİR', 'HACIÜKTAŞ', 'KOZAKLI', 'MERKEZ', 'ÜRGÜP'],
    ...
    'RİZE': ['ARDEŞEN', 'ÇAMLIHEMŞİN', 'ÇAYELİ', 'DEREPAZARI', 'FINDIKLI', 'GÜNEYSU', 'HEMŞİN', 'İKİZDERE', 'İYİDERE', 'KALANDERE', 'MERKEZ', 'PAZAR'],
    ...
    'TRABZON': ['AKÇAABAT', 'ARAKLI', 'ARSİN', 'BEŞİKDÜZÜ', 'ÇARŞIBAŞI', 'ÇAYKARA', 'DERNEKPAZARI', 'DÜZKÖY', 'HAYRAT', 'KÖPRÜBAŞI', 'MAÇKA', 'OF', 'ORTAHİSAR', 'ŞALPAZARI', 'SÜRMENE', 'TONYA', 'VAKFIKEBİR', 'YOMRA'],
    ...
    'YALOVA': ['ALTINOVA', 'ARMUTLU', 'ÇİFTLİKKÖY', 'ÇINARCIK', 'MERKEZ', 'TERMAL'],
    'YOZGAT': ['AKDAĞMADENİ', 'AYDINCIK', 'BOĞAZLIYAN', 'ÇANDIR', 'ÇAYIRALAN', 'ÇEKEREK', 'KADIŞEHRİ', 'MERKEZ', 'SARAYKENT', 'SARIKAYA', 'ŞEFAATLİ', 'SORGUN', 'YENİFAKILI', 'YERKÖY'],
  ...
  static List<String> getDistricts(String city) {
    return citiesAndDistricts[city.toUpperCase()] ?? [];
  }
}
