...
class AgmCycle {
  ...
  // Özel Sınıf Ayarları
  final bool isSpecialClassEnabled;
  ...
  AgmCycle({
    ...
    this.isSpecialClassEnabled = false,
  ...
  Map<String, dynamic> toMap() {
    ...
    final data = {
      ...
      'isSpecialClassEnabled': isSpecialClassEnabled,
  ...
  factory AgmCycle.fromMap(Map<String, dynamic> map, String id) {
    return AgmCycle(
      ...
      draftSubjectThresholds: (map['draftSubjectThresholds'] as Map<String, dynamic>?)?.map(
          ...
          {},
      isSpecialClassEnabled: map['isSpecialClassEnabled'] ?? false,
  ...
  AgmCycle copyWith({
    ...
    return AgmCycle(
      ...
      isSpecialClassEnabled: isSpecialClassEnabled ?? this.isSpecialClassEnabled,
