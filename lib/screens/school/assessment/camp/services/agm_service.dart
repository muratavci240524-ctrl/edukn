...
class AgmService {
  ...
  Future<AgmDraftResult> generateDraft({
    ...
    engine.isSpecialClassEnabled = cycle.isSpecialClassEnabled;
    engine.specialClassCapacity = cycle.specialClassCapacity;
    engine.specialClassRoomId = cycle.specialClassRoomId;
